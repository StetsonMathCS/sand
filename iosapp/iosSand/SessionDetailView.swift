...
struct SessionDetailView: View {
    ...
    var body: some View {
        VStack {
            if request.matched {
                Text(request.classRequest).frame(width: screenSize.width, height: screenSize.width/6, alignment: .center).font(.system(size: 36, weight: .thin, design: .default)).foregroundColor(Color.yellow)
                ...
                Text(request.classRequest).frame(width: screenSize.width, height: screenSize.width/6, alignment: .center).font(.system(size: 36, weight: .thin, design: .default)).foregroundColor(Color.gray)
